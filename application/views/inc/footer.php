            ...
            <div class="col-md-6 col-sm-6 col-xs-12 pd-lr50 m-top20-xs text-center">
                ...
                <p class="flef100 cl-fff text-justify m-top80">
                    ...
                    <small class="fleft100"><br>A Livre.digital é uma plataforma de crédito on-line, atuando como correspondente bancário do Banco Topázio, sob o CNPJ 30.472.737/0001-78. Como correspondente bancário, seguimos as diretrizes do Banco Central do Brasil, nos termos da Resolução nº. 3.954, de 24 de fevereiro de 2011.  
                        <br><br>*informações gerais. Prazo de pagamento: O período mínimo para pagamento é de 4 meses e o máximo de 12 meses. Custo Efetivo Total: O Custo Efetivo Total (CET) praticado varia de 47,68% a 77,54% ao ano, já incluindo a taxa de juros mensal que varia de 1,89% a 7,87% e a taxa de abertura de cadastro (TAC) de 20% sobre o valor tomado. Exemplo: Valor do crédito de R$ 5.000,00 para pagar em 12 (doze) meses. Total de 12 (doze) parcelas de R$ R$ 615,33. Detalhes referentes às taxas do crédito: Valor total a pagar: R$ 7.383,96. CET: 47,68% na operação e 47,68% ao ano.
