...
<body>
	<header class="fleft100 pd-tb30 hinter center-xs">
		<div class="container">
			<div class="logo col-md-2 col-sm-2 col-xs-12 pd-0 center-xs">
                            <a href=""><img src="<?php  echo base_url().'assets/img/icones/logo-interna.png'?>" alt="">
                            </a>
                        </div>
			<div class="logo col-md-7 col-sm-7 col-xs-12">
			...
			<div class="col-md-3 col-sm-3 col-xs-12 pd-0 text-right center-xs">
