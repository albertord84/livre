	...
	<tbody>
	    <tr>
	        <td colspan="3" height="180" bgcolor="#fffd00" align="center">
	    		<h1 style="font-weight: 600;font-size: 30px;line-height: 30px">Suas fotos não <br>foram aprovadas <br><small style="font-size:18px">Veja o passo a passo abaixo:</small></h1>
	  		</td>
	    </tr>
	    <tr>
	        <td width="105"></td>
	        <td width="440" valign="top" align="center" height="40">
	        	<br><br>
	          	<img src="img/icones/fnaprovadas.jpg" alt="">   
          		<br><br>
	          	<div style="text-align: left;">
					...
					<a href="" style="background-color: #00ff66;padding: 10px 50px !important;font-weight: 600;color: black;text-align: center;border: none;border-radius: 30px !important;text-decoration: none;display: block;">Enviar novas fotos</a>
					<p>
