	...
	<div class="container">	
		<div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-2  m-top150">
			<div class="fleft100 selct">
				<h2 class="bk-green5 text-center pd-tb15 fw-800"><i class="far fa-check-circle"></i> PRONTO!</h2>
				<div class="fleft100 pd-30 bk-fff">
					<div class="fleft100 pd-lr30 m-top30 ft-size16 fmr-check">
						<h4 class="cl-blue m-b15">Parabéns, Marcio!</h4>
						<p>
							Agora só precisamos analisar suas fotos e liberar seu dinheiro. Se tudo estiver certo, em 24h você receberá o valor solicitado. 
							<br><b>Enviaremos e-mails de atualizações sobre o seu pedido.</b> Caso as fotos não estejam legíveis, solicitaremos novas por e-mail.
						</p>

						<ul class="pap fleft100 pd-lr80 text-center m-top30">
							<li class="pgreen">
						...
						<div class="fleft100 m-top30 m-b20">
							<h4 class="cl-blue m-b10">Está com dúvidas?</h4>
							<p>
								Fala com a gente pelo e-mail:  <b>seja@livre.digital</b>
							</p>
						</div>
					</div>
				</div>
