            ...
            <div class="verific prelative m-top40 m-top20-xs text-right center-xs">
                <div id="verify_container">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 text-center">
                        <input id="input_verify" type="text" class="bverde ph-fff cl-fff" title="de R$ 0500 até R$ 3000" placeholder="R$ 0.00" maxlength="13" data-thousands="." data-decimal="," data-prefix="R$ " >                        
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12 text-center">
