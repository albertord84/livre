                ...
                <div class="cad2 d-none fleft100">
                    <div class="pd-0 col-md-7 col-sm-9 col-xs-12  fnone i-block text-left">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12 pd-40 bk-fff h441">
                            ...
                            <fieldset class="fleft100 col-md-12 pd-lr10">
                                <input type="text" value="Marcio Araujo Paiva">
                            </fieldset>	
                            <fieldset class="fleft100 col-md-12 pd-lr10">
                                <input type="text" placeholder="CPF ou CNPJ">
                            </fieldset>	
                        </div>
                        <div class="fleft100 m-top10 text-right center-xs"><button class="bt-green px2">Cadastre-se</button></div>
                    </div>
                </div>
