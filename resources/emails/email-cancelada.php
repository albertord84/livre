	...
	<tbody>
	    <tr>
	        <td colspan="3" height="180" bgcolor="#ff1945" align="center">
	    		<h1 style="font-weight: 600;font-size: 30px;line-height: 30px;color:#fff">Solicitação cancelada</h1>
	  		</td>
	    </tr>
	    <tr>
	        <td width="105"></td>
	        <td width="440" valign="top" align="center" height="40">
	          	...
	          	<div style="text-align: left;">
					...
					<p>
						...
						<br><br>
						Por este motivo sua transação foi cancelada, incluindo a operação no seu cartão de crédito.
						<br><br>
						Entre em contato com <b>seja@livre.digital</b> para mais informações
					</p> 					
	          	</div> 	          
	        </td>
	        <td width="105"></td>
