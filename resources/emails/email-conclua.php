	...
	<tbody>
	    <tr>
	        <td colspan="3" height="180" bgcolor="#fffd00" align="center">
                    <h1 style="font-weight: 600;font-size: 30px;line-height: 30px">Conclua seu cadastro <br>                        
                    </h1>
                </td>
	    </tr>
	    <tr>
	        ...
	        <td width="440" valign="top" align="center" height="40">
                    <br><br>
                    <img src="../../assets/img/icones/03 - conclua seu cadastro.png" alt="">   
                    <br><br>
                    <div style="text-align: left;">
                        <h2 style="color: #20a7d3;">Oi <?php echo urldecode($_GET["name"]);?>!</h2>
                        <p>
                            Faltou muito pouco para seguir com sua solicitação. Você tem alguma dúvida?<br> Se precisar, escreva para nós e  te ajudamos com qualquer dúvida. <br><br>                            
                        </p> 
                        <p>
                            Esperamos você!
                        </p>
